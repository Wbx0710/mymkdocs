...
### 十进制（Decimal）
表示为$(xxx)_{10}$或$(xxx)_D$ eg：$(114)_{10}$或$(514)_D$
...
### 二进制（Binary）
表示为$(xxx)_{2}$或$(xxx)_B$ eg：$(1011.11)_{2}$或$(1011.11)_B$
...
### 八进制（Octal）
表示为$(xxx)_{8}$或$(xxx)_O$ eg：$(573.46)_{8}$或$(573.46)_O$
...
### 十六进制（Hexadecimal）
表示为$(xxx)_{16}$或$(xxx)_H$ eg：$(5EC.D4)_{16}$或$(5EC.D4)_H$
...
### 不同数制间的转换
#### 二、八、十六进制转换为十进制
* 将按位权展开式**按照十进制规律相加**，即得对应**十进制数**（**按位权展开再求和**）
...
##### 八进制和十六进制间的转换
八进制和十六进制之间没有直接的快速转换方式，只得通过二进制作为桥梁
...
##### 余3码
无权码，比8421BCD码多余3（0011），也就是比8421BCD码多了3
...
!!! warning "多少位十进制数就要用多少个四二进制数表示"
	...
	* $(10)_{10}$等于多少？$(1010)_{8421BCD}$？错！要分成1和0两位来分别表示$(10)_{10}=(00010000)_{8421BCD}$

<img src="https://wbx-1328220477.cos.ap-shanghai.myqcloud.com/202501151128256.png" alt="屏幕截图 2025-01-15 112759" style="zoom:67%;" />

!!! tip "注意区别BCD码与数制"
	* 相互之间的转换：$(150)_{10}=(0001\ 0101\ 0000)_{8421BCD}=(1001\ 0110)_2=(226)_8=(96)_{16}$
